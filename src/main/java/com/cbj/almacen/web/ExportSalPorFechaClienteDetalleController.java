...
@Controller
@Scope("prototype")
@RequestMapping("/exportSalPorFechaClienteDetalle")
public class ExportSalPorFechaClienteDetalleController {
    ...
    private JasperReportBuilder createJasperReport(String fechaInicio,String fechaFin, String idCliente, String nombreCliente) {
        ...
        try {
            ...
            //TextColumnBuilder<Double> quantityTotKgs = col.column("Total Kgs", "pesoTotal", type.doubleType());
            ...
            return report()//create new report design
                    ...
                    .columns(//add columns
                            ...
                            col.column("Renglon", "renglon", type.stringType()).setWidth(50).setPattern("###,###,###"),
                            col.column("Camara", "camara", type.stringType()).setWidth(50),
                            ...
                            .add(cmp.image(url).setFixedDimension(80, 80),
                                    cmp.verticalList()
                                            .add(
                                                    ...
                                                    cmp.text(nombreCliente).setStyle(textStyle2).setWidth(310).setHorizontalAlignment(HorizontalAlignment.LEFT),
    ...
    private JRDataSource createDataSource(String fechaInicio,String fechaFin,String idCliente) {
        ...
        final List<Object[]> oList = this.salidasDetalleManager.getKilosByFechasClienteDetalle(dateInicio, dateFin, idCliente);
        ...
        for (Object[] o : res) {
            ...
            try {
                ...
                salidasDetalle.setRenglon((String) o[3]);
                salidasDetalle.setCamara((String) o[4]);
                salidasDetalle.setDescripcion((String) o[5]);
                salidasDetalle.setCaducidad((String) o[6]);
                salidasDetalle.setLote((String) o[7]);
                salidasDetalle.setMarca((String) o[8]);
                salidasDetalle.setCantidadSalida((Double) o[9]);
                salidasDetalle.setPesou((Double) o[11]);
