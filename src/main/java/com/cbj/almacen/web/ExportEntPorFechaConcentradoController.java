...
@Controller
@Scope("prototype")
@RequestMapping("/exportEntPorFechaConcentrado")
public class ExportEntPorFechaConcentradoController {
    ...
    private JasperReportBuilder createJasperReport(String fechaInicio,String fechaFin) {
        ...
        try {
            ...
            TextColumnBuilder<Double> quantityPza = col.column("Piezas", "cantidad", type.doubleType()).setPattern("###,###,###");
            TextColumnBuilder<Double> quantityKgs = col.column("Kilos que entraron", "pesoTotal", type.doubleType()).setPattern("###,###,###.##");
    ...
    private JRDataSource createDataSource(String fechaInicio,String fechaFin) {
        ...
        final List<Object[]> oList = this.detalleRdManager.getKilosByFechasConcentrado(dateInicio,dateFin);
        ...
        for (Object[] o : res) {
            ...
            try {
                Date fechaDate = sdfQuery.parse(String.valueOf(o[0]));
