...
@Controller
@Scope("prototype")
@RequestMapping("/exportEntPorFecha")
public class ExportEntPorFechaController {
    ...
    private JRDataSource createDataSource(String fechaInicio,String fechaFin) {
        ...
        final List<Object[]> oList = this.detalleRdManager.getKilosByFechas(dateInicio,dateFin);
