...
public class InventariosController {
                                     ...
                                     @RequestParam(value = "tunel") String tunel )
    {
        ...
        if (idCliente.equals("526")) {
            ...
            return "reporteSigma";
        }else if(idCliente.equals("258")){
            return "reporteGifan";
        }else if(idCliente.equals("538")){
            model.addAttribute("detallesRD",this.detalleRdManager.getAllByCliente(idCliente));
            return "reporteAlsea538";
        }else if(idCliente.equals("186")){
            model.addAttribute("detalles",this.detalleRdManager.getAllByCliente(idCliente));
            return "reporteCitrofrut";
        }else if(idCliente.equals("51") || idCliente.equals("388") || idCliente.equals("468") || idCliente.equals("472")){
            return "reporteQualtia";
        }else if(idCliente.equals("550") || idCliente.equals("551") || idCliente.equals("552") || idCliente.equals("1550") || idCliente.equals("1551") || idCliente.equals("606") || idCliente.equals("650") || idCliente.equals("1650") || idCliente.equals("1651")){
            return "reporteArla";
        }else if(idCliente.equals("531")){
            return "reporteAgrosuper";
        }else if(idCliente.equals("618") || idCliente.equals("1619")){
            return "reportePesquero";
        }else if(idCliente.equals("333")){
            model.addAttribute("posicionesV",Math.ceil(this.inventarioManager.getPosicionesProbocaV()));
            model.addAttribute("posicionesC",Math.ceil(this.inventarioManager.getPosicionesProbocaC()));
            model.addAttribute("posicionesI",Math.ceil(this.inventarioManager.getPosicionesProbocaI()));
            model.addAttribute("posicionesC2",Math.ceil(this.inventarioManager.getPosicionesProbocaC2()));
            model.addAttribute("posicionesArrachera",Math.ceil(this.inventarioManager.getPosicionesProbocaArrachera()));
            model.addAttribute("posicionesEmpanizado",Math.ceil(this.inventarioManager.getPosicionesProbocaEmpanizado()));
            model.addAttribute("posicionesOtro",Math.ceil(this.inventarioManager.getPosicionesProbocaOtro()));
            return "reporteGifan";
        }else if(idCliente.equals("340")){
            model.addAttribute("detalles",this.detalleRdManager.getAllByCliente(idCliente));
            return "reporteJumex";
        }
