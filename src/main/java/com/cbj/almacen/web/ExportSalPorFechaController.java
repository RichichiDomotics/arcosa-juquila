...
@Controller
@Scope("prototype")
@RequestMapping("/exportSalPorFecha")
public class ExportSalPorFechaController {
    ...
    private JRDataSource createDataSource(String fechaInicio,String fechaFin) {
        ...
        final List<Object[]> oList = this.salidasDetalleManager.getKilosByFechas(dateInicio,dateFin);
