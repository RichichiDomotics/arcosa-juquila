...
@Controller
@Scope("prototype")
@RequestMapping("/exportEntPorFechaCliente")
public class ExportEntPorFechaClienteController {
    ...
    private JRDataSource createDataSource(String fechaInicio,String fechaFin,String idCliente) {
        ...
        final List<Object[]> oList = this.detalleRdManager.getKilosByFechasCliente(dateInicio, dateFin,idCliente);
        ...
        for (Object[] o : res) {
            ...
            try {
                ...
                detallesRd.setCantidad((Double) o[1]);
                detallesRd.setPesoTotal((Double) o[2]);
