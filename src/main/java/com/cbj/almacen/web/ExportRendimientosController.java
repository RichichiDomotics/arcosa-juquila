...
public class ExportRendimientosController {
    ...
    private JRDataSource createDataSource(String fechaInicio, String fechaFin) {
        ...
        while(var11.hasNext()) {
            ...
            logger.info("Registro: "+ Arrays.toString(o));
            try {
                ...
                int periodo = Integer.valueOf(String.valueOf(o[15]));
                detallesRd.setLote2(String.valueOf(periodo));
                Double proc = Double.valueOf(String.valueOf(o[16]));
                detallesRd.setLote3(String.valueOf(o[16]));
                detallesRd.setLote4(String.valueOf(o[17]));
                Double superficie = Double.valueOf(String.valueOf(o[10]));
                Double rend = 0d;//Double.valueOf(String.valueOf(o[17]));
                if(periodo ==30){
                    rend = proc *1;
                }else if(periodo==1){
                    rend = proc *30;
                ...
                detallesRd.setLote6(String.valueOf(rend));
                detallesRd.setLote5(String.valueOf(Math.rint((rend/superficie)*100)/100));
                //detallesRd.setLote5("=T"+i+"/L"+i);
