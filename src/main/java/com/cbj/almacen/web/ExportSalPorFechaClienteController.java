...
@Controller
@Scope("prototype")
@RequestMapping("/exportSalPorFechaCliente")
public class ExportSalPorFechaClienteController {
    ...
    private JasperReportBuilder createJasperReport(String fechaInicio,String fechaFin, String idCliente, String nombreCliente) {
        ...
        try {
            ...
            TextColumnBuilder<Double> quantityKgs = col.column("Kilos que salieron", "pesou", type.doubleType()).setPattern("###,###,###.##");
    ...
    private JRDataSource createDataSource(String fechaInicio,String fechaFin,String idCliente) {
        ...
        final List<Object[]> oList = this.salidasDetalleManager.getKilosByFechasCliente(dateInicio, dateFin,idCliente);
        ...
        for (Object[] o : res) {
            ...
            try {
                ...
                salidasDetalle.setCantidadSalida((Double) o[1]);
                salidasDetalle.setPesou((Double) o[2]);
                salidasDetalle.setConsecutivo((Integer) o[3]);
                salidasDetalle.setFolioSalida((Integer) o[4]);
