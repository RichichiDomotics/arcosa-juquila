...
@Controller
@Scope("prototype")
@RequestMapping("/exportSalPorFechaConcentrado")
public class ExportSalPorFechaConcentradoController {
    ...
    public void export(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            JasperReportBuilder jrb = createJasperReport(fechaInicio,fechaFin);
    ...
    private JasperReportBuilder createJasperReport(String fechaInicio,String fechaFin) {
        ...
        try {
            ...
            TextColumnBuilder<Double> quantityPza = col.column("Piezas", "cantidadSalida", type.doubleType()).setPattern("###,###,###").setWidth(35);
            TextColumnBuilder<Double> quantityKgs = col.column("Kilos que salieron", "pesou", type.doubleType()).setPattern("###,###,###.##").setWidth(35);
            ...
            return report()//create new report design
                    ...
                    .columns(//add columns
                            ...
                            col.column("Fecha", "fechaSalida", type.dateType()).setWidth(35),
                            /*col.column("RD", "consecutivo", type.integerType()).setPattern("###########").setWidth(35),
                            col.column("Folio Salida", "folioSalida", type.integerType()).setWidth(35),
                    ...
                    .setDataSource(createDataSource(fechaInicio, fechaFin))//set datasource
    ...
    private JRDataSource createDataSource(String fechaInicio,String fechaFin) {
        ...
        final List<Object[]> oList = this.salidasDetalleManager.getKilosByFechasConcentrado(dateInicio,dateFin);
        ...
        for (Object[] o : res) {
            ...
            try {
                ...
                salidasDetalle.setConsecutivo((Integer) o[3]);
