...
public class ImprimirEntradasManagerImpl implements ImprimirEntradasManager {
    ...
    public boolean imprimirEntrada(int consecutivo) {
        ...
        String cliente_completo=clienteDao.findCliente(Integer.parseInt(detallesRds.get(0).getIdCliente())).getIdCliente()+" "+clienteDao.findCliente(Integer.parseInt(detallesRds.get(0).getIdCliente())).getNombreCliente();
        ...
        try {
		   ...
		   */
            ...
            String [] contenido= {"","","FRIGORIFICO: JUQUILA","","ANDEN DESIGNADO: "+anden,"FECHA: "+detallesRds.get(0).getFechaCaptura(),
                    "CLIENTE: "+cliente_completo,"CAMARA:"+detallesRds.get(0).getCamara(),"PEDIMENTO: "+detallesRds.get(0).getImpedimento(),
