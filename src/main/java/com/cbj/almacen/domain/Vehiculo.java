...
@NamedQueries({
		...
		@NamedQuery(name = "Vehiculo.getIdIngresoVehiculo",
				query="SELECT v FROM Vehiculo v where v.idIngresoVehiculo = :idIngresoVehiculo"),
		@NamedQuery(name = "Vehiculo.getAll",
