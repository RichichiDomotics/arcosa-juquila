...
@NamedQueries({
        ...
        @org.hibernate.annotations.NamedQuery(name="DetalleFacturacion.getPreFacturas",
                query="SELECT c.idCliente, c.rd, c.fechainiper, c.fechafinper, c.camara, c.kilos, c.tiposervicio, c.total, c.fechafactura FROM DetalleFacturacion c WHERE c.nofactura = '' and (c.fechafactura >= :fechaini and c.fechafactura <= :fechafin) and c.idCliente = :idcliente"),
