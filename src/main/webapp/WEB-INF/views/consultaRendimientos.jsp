...
<script>
    $(document).ready(function(){
        ...
        $(".busca").click(function(){
            ...
            if($("#fecini").val()==""){
                alert("Ingresa la fecha inicial de busqueda.");
                $("#fecini").focus();
                return false;
            }

            if($("#fecfin").val()==""){
                alert("Ingresa la fecha final de busqueda.")
                $("#fecfin").focus();
                return false;
            }
            fecini = $("#fecini").val();
            ...
            $("#resultadoBuscaData").html("<a class='btn btn-primary' target='_blank' href='exportRendimientos?type=xls&fecini="+fecini+"&fecfin="+fecfin+"'><i class='icon-download-alt bigger-125'></i>REPORTE</a>");
