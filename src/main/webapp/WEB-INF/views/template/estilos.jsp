...
<!--basic styles-->
		...
		<link rel="stylesheet" href="resources/assets/css/fontgoogle.css" />
...
<script type="text/javascript" src="resources/bootstrap/js/inicial.js"></script-->

<!--script type="text/javascript" src="resources/js/jquery.form.js"></script>
<script type="text/javascript" src="resources/js/jquery.validate.js"></script-->

		<!-- script src="resources/bootstrap/js/cufon-yui.js" type="text/javascript"></script>
		<script src="resources/bootstrap/js/cufon-replace.js" type="text/javascript"></script>
		<script src="resources/bootstrap/js/Mate_400.font.js" type="text/javascript"></script>
		<script src="resources/bootstrap/js/FF-cash.js" type="text/javascript"></script>
		<script src="resources/bootstrap/js/tms-0.3.js" type="text/javascript"></script>
		<script src="resources/bootstrap/js/tms_presets.js" type="text/javascript"></script>
