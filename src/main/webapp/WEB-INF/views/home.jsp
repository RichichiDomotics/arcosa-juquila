...
<div class="inicioPrincipal">
	...
	<div class="row-fluid">
		<div class="span7 infobox-container">
			<c:if test="${(rolef eq 'ROLE_FACTURACION') || (rolef eq 'ROLE_OPERACION') ||(rolef eq 'ROLE_VIGILANTE') || (rolef eq 'ROLE_ADMIN')}">
				<div class="infobox infobox-blue">
					...
					<div class="infobox-data">
						<div class="infobox-content">Tr&aacute;fico</div>
			...
			<c:if test="${(rolef eq 'ROLE_FACTURACION')|| (rolef eq 'ROLE_MAQUILA') || (rolef eq 'ROLE_OPERACION') || (rolef eq 'ROLE_ADMIN') || (rolef eq 'ROLE_TIF') || (rolef eq 'ROLE_AUDITORIA')}">
				<div class="infobox infobox-blue">
					<div class="infobox-icon">
			...
			<c:if test="${(rolef eq 'ROLE_FACTURACION') || (rolef eq 'ROLE_MAQUILA') ||(rolef eq 'ROLE_ALMACENISTA') || (rolef eq 'ROLE_OPERACION') || (rolef eq 'ROLE_ADMIN') ||(rolef eq 'ROLE_COMERCIAL_GERENTE') || (rolef eq 'ROLE_AUDITORIA') || (rolef eq 'ROLE_TIF')}">
				<div class="infobox infobox-blue">
					<div class="infobox-icon">
						<i class="icon-book"></i>
					</div>
