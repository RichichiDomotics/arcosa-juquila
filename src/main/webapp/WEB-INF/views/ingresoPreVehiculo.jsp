...
<section class="container">
	<h1 id="item_name">Registro Tr&aacute;fico</h1>
		...
		<section class="grupodedatos">
			<div class="bloquedata">
				...
				<div class="form-group">
					...
					<select id="planta" name="planta" value='' class="form-control" required>
						<option value="" ><fmt:message key="entradas.select"/></option>
    		...
    		<option value="" ><fmt:message key="entradas.select"/></option>
				...
				<div class="form-group">
					...
					<select id="puerta" name="puerta" value='' class="form-control" required>
						...
						<option value="PUERTA 6" > PUERTA 6 </option>
						<option value="PUERTA 7" > PUERTA 7 </option>
						<option value="PUERTA 8" > PUERTA 8 </option>
						<option value="PUERTA 9" > PUERTA 9 </option>
						<option value="PUERTA 10" > PUERTA 10 </option>
						<option value="PUERTA 11" > PUERTA 11 </option>
						<option value="PUERTA 12" > PUERTA 12 </option>
						<option value="PUERTA 13" > PUERTA 13 </option>
					</select>
				</div>
			</div>
			<div class="bloquedata">
