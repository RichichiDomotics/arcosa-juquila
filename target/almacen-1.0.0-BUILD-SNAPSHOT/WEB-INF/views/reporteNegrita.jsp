  ...
  <tbody aria-relevant="all" aria-live="polite" role="alert">
    <c:forEach items="${reporte}" var="det">
      <tr>
        ...
        <td>${det.embalaje}</td>
        <td>${det.caducidad}</td>
        <td><fmt:formatNumber  type="number" minFractionDigits="2" value="${det.pesoBruto}"/></td>
...
<div id="totalInventario">Total Kilos :<fmt:formatNumber type="number" minFractionDigits="2" value="${total}"/></div>
<br><div id="totalInventario">Total Piezas :<fmt:formatNumber type="number" minFractionDigits="2" value="${totalpzas}"/></div>