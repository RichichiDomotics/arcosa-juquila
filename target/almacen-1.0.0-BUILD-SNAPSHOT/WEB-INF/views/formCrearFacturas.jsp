...
<section class="container">
  <h1 class="item_name">Crear Facturas</h1>
  <form:form method="post" action="consultaVentas">
    <section class="grupodedatosRetemes">
      <div class="bloquedata">
        ...
        <div class="form-group">
          <br>
          <button class="btn btn-primary btn-small consultaFacturas" type="button">
    ...
    <div id="buscaretemes">
      <table aria-describedby="sample-table-2_info" id="sample-table-2" class="table table-striped table-bordered table-hover dataTable">
        ...
        <c:forEach items="${clientes}" var="c">
          <tr class="odd">
            <td align="center" >
              <input type="checkbox" id="idcliente" name="idcliente" value="${c.idCliente}"><span class="lbl"></span>
            </td>
            <td>${c.idCliente} ${c.nombreCliente}</td>
            <td>${c.diasRevision}</td>
            <td>${c.diasPago}</td>
            <td>${c.facturacion}</td>
          </tr>
        </c:forEach>
