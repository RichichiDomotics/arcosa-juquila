...
<br><div id="totalInventario">Posiciones al d&iacute;a :<fmt:formatNumber type="number" pattern="###,###,###.##" value="${posicionesV+posicionesC+posicionesI+posicionesC2+posicionesArrachera+posicionesEmpanizado+posicionesOtro}"/></div>