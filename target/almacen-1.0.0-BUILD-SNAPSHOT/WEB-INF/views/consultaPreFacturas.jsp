...
<script src="resources/assets/js/date-time/ver-1.4.0/js/bootstrap-datepicker.min.js"></script>
...
<link rel="stylesheet" type="text/css" href="resources/bootstrap/css/retemes.css" />
<link rel="stylesheet" type="text/css" href="resources/assets/js/date-time/ver-1.4.0/css/bootstrap-datepicker.css" />
<link rel="stylesheet" type="text/css" href="resources/assets/js/date-time/ver-1.4.0/css/bootstrap-datepicker.min.css" />
<link rel="stylesheet" type="text/css" href="resources/assets/js/date-time/ver-1.4.0/css/bootstrap-datepicker.standalone.css" />
<link rel="stylesheet" type="text/css" href="resources/assets/js/date-time/ver-1.4.0/css/bootstrap-datepicker.standalone.min.css" />
<script type="text/javascript" src="resources/js/facturas.js"></script>
...
<style>
  .bloquedataResultadoget{
    display: inline-block;
    width: 950px;
  }
</style>
<section class="container">
  <h1 class="item_name">Crear Pre-Facturas</h1>
    ...
    <section class="grupodedatosRetemes">
      <div class="bloquedata">
        ...
        <div class="form-group">
          <div style="display: block;" class="widget-body-inner">
            <div class="widget-main">
              <label>FECHAS (INICIAL-FINAL)</label>
              <section class="grupodedatosreporte">
                <div class="bloquedata">
                  <div class="form-group">
                    <div class="row-fluid input-append">

                      <input class="span3 date-picker" data-date-format="dd/mm/yyyy" type='text' id="fecini" name='fecini' placeholder="DD/MM/AAAA" value='' maxlength="10">
                					<span class="add-on">
										<i class="icon-calendar"></i>
									</span>
                      <div class="row-fluid input-append">

                        <input class="span3 date-picker" data-date-format="dd/mm/yyyy" type='text' id="fecfin" name='fecfin' value='' placeholder="DD/MM/AAAA" maxlength="10">
               	 						<span class="add-on">
											<i class="icon-calendar"></i>
										</span>
                      </div>
        ...
        <div class="form-group">
          <br>
          <button class="btn btn-primary btn-small consultaPreFacturas" type="button">
  ...
  <div class="bloquedataResultadoget">
